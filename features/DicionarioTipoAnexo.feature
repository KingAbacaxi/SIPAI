...
Quando Preecher os campos titulo 'DOC' ordem '1' Ativo 'sim' descricao 'Documento padrão DOC'
...
Quando pesquisar pela descricao 'DOC'
Então sistema deve exibir no Grid somente os itens que tenham 'DOC' na descricao 

Cenario: Verificar pesquisa do dicionario de Tipo de Anexo para pesquisa de titulo
Quando pesquisar pelo titulo 'DOC'
Então sistema deve exibir no Grid somente os itens que tenham 'DOC' no titulo
...
Quando pesquisar o item de titulo 'DOC'
...
E clicar em Dicionario Tipo de Anexo
E clicar em editar no grid
